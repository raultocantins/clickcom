...
<head>
	...
	<link rel="shortcut icon" href="/../../imgs/agro365-3.png" />
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable">
	...
	<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
		...
		<a href="/graficos">
			<!-- <img width="100" alt="Logo" src="/../../imgs/agro365-2.png" /> -->
	...
	<div class="d-flex flex-column flex-root" >
		<div class="d-flex flex-row flex-column-fluid page">
			...
			<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside" style="overflow-y: auto; background-color:#004100;">
				<!-- begin:: Aside -->
				<div class="brand flex-column-auto" id="kt_brand" style="background-color:#004100;">

					<a href="/graficos" class="brand-logo">
						<!-- <img width="160" alt="Logo" src="../../imgs/agro365-2.png" /> -->
						@if($logo == "")
						<!-- <img width="100" alt="Logo" src="../../imgs/slym.png" /> -->
						<!-- <img width="100" alt="Logo" src="/../../imgs/agro365-2.png" /> -->
				...
				<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
					<div id="kt_aside_menu" class="aside-menu my-4" data-menu-dropdown-timeout="500" style="backgound-color:#004100;">

						<ul class="menu-nav" id="menu-color">
							@if(session('user_logged')['super'] == 1)
							<li class="menu-item menu-item-submenu menu-item" aria-haspopup="true" data-menu-toggle="hover">
								<a style="background: #0B660B" href="javascript:;" class="menu-link menu-toggle">
							...
							<li class="menu-item menu-item-submenu menu-item" aria-haspopup="true" data-menu-toggle="hover">
								<a style="background: #0B660B" href="javascript:;" class="menu-link menu-toggle">
									...
									<span class="menu-text text-light">REPRESENTANTE</span>
									<!-- <i class="la la-arrow-down"></i> -->
								</a>
								<div class="menu-submenu " style="" kt-hidden-height="320">
									<i class="menu-arrow"></i>
									...
									<ul class="menu-nav">
										...
										<li class="menu-item menu-item-submenu menu-item-rel menu-item-active" data-menu-toggle="click" aria-haspopup="true">
											<a href="/assinarContrato" class="label label-xl label-inline @if($tema == 1) label-light-danger @else label-danger @endif">
												<i class="la la-file-alt text-danger"></i>
												Assinar contrato
											</a>
										</li>
										@endif
							...
							<div id="kt_subheader" class="subheader py-2 py-lg-4  subheader-solid ">
								...
								<div class="topbar-item not-mobile" style="display: none">
									<div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2">
										...
										<span style="margin-left: 3px; width: 1005" class="kt-header__topbar-username kt-hidden-mobile"> <span style="font-weight: bold;" class="text-success text-left">{{ $ultimoAcesso->ip_address }}</span></span>
									</div>
								</div>
					...
					<div id="box_whatsapp" class="wcard">
						<div class="wcard-header">
							<div class="wcard-logo">
								<img src="/imgs/agro365-3.png" alt="Nome da empresa">
							</div>
						...
						<div class="wcard-body">
							<div id="form_whatsapp">
								<div class="wcard-campo">
									<label for="w_nome"> Olá! Preciso de ajuda no e-commerce da AGRO365:</label>
