...
class DeliveryConfig extends Model
{
	protected $fillable = [
		...
		'nome_exibicao_web', 'latitude', 'longitude', 'politica_privacidade', 
		'entrega_gratis_ate', 'valor_km', 'usar_bairros', 'maximo_km_entrega', 
		'maximo_adicionais', 'maximo_adicionais_pizza', 'empresa_id'
	];
