...
function habilitaBtnSalvar(){
	...
	// if(MUNIPIOSCARREGAMENTO.length > 0 && INFODESCARGA.length > 0 && $('#cnpj_contratante').val().length > 10 && VEICULOREBOQUE != null && VEICULOTRACAO != null && camposValidos){
	if(MUNIPIOSCARREGAMENTO.length > 0 && INFODESCARGA.length > 0 && $('#cnpj_contratante').val().length > 10 && VEICULOTRACAO != null && camposValidos){
