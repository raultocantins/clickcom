...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
	<form method="post" enctype="multipart/form-data" action="/migrador">
				...
				<div class="col-lg-12">
					...
					<div class="card card-custom gutter-b example example-compact">
						<div class="card-header">
							...
							<h3 class="card-title">Importação de SQL
							...
							<div class="form-group validated col-sm-10 col-lg-10">
								...
								<div class="">
									<span class="btn btn-primary btn-file">
										Procurar arquivo<input accept=".sql" name="file" type="file">
									</span>
