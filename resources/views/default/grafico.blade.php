		...
		<div class="row @if(getenv('ANIMACAO')) animate__animated @endif animate__backInRight">
			...
			<div class="col-sm-6 col-lg-4 col-md-4 col-xl-2">
				...
				<div class="col bg-light-success px-6 py-8 rounded-xl mb-7">
					...
					<a target="_blank" class="text-success font-weight-bold font-size-h6 mt-2">Vendas: <strong id="tot-vendas">{{number_format($totalDeVendas, 2, ',', '.')}}</strong></a>
				</div>
			</div>
			...
			<div class="col-sm-6 col-lg-4 col-md-4 col-xl-2">
				...
				<div class="col bg-light-info px-6 py-8 rounded-xl mb-7">
					...
					<a href="/pedidosDelivery" target="_blank" class="text-info font-weight-bold font-size-h6 mt-2">Pedidos: <strong id="tot-pedidos">{{$totalDePedidos}}</strong></a>
				</div>
			</div>
