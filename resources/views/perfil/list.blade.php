					...
					<div class="card card-custom gutter-b example example-compact">
						<div class="card-header">
							...
							<div class="card-toolbar">
								...
								<a href="/perfilAcesso/edit/{{$p->id}}" class="btn btn-icon btn-circle btn-sm btn-light-primary mr-1"><i class="la la-pencil"></i></a>
								<a href="/perfilAcesso/delete/{{$p->id}}" class="btn btn-icon btn-circle btn-sm btn-light-danger mr-1"><i class="la la-trash"></i></a>
