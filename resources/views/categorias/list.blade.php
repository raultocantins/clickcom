				...
				<div class="col-sm-12 col-lg-6 col-md-6 col-xl-4">
					<div class="card card-custom gutter-b example example-compact">
						<div class="card-body">
							...
							<p><strong>Subcategorias:</strong> {{sizeof($c->subs)}}</p>
							<div class="card-toolbar">
								...
								<a title="Sub categorias" href="/subcategorias/list/{{$c->id}}" class="btn btn-icon btn-circle btn-sm btn-light-info mr-1"><i class="la la-list"></i></a>
